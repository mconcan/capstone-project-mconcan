#
# Adapted by Megan Concannon from Bill Tran's plot: https://raw.githubusercontent.com/mrbilltran/the-win-column/master/nhl_rink_plot.R
# Updated 5/18/21
#
